...
* Submit a state's name, postal abbreviation or "FIPS code":https://en.wikipedia.org/wiki/Federal_Information_Processing_Standards and receive a clean object with all other formats as attributes.
...
ValueError: The state you requested does not exist</code></pre>
